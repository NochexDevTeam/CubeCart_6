...
if($this->_module['xmlMode'] == "1"){
	...
	$itemCollect .= "<item><id></id><name>" . $product['name'] . "</name><description>" . $product['description'] . "</description><quantity>" . $product['quantity'] . "</quantity><price>" . $product['price'] . "</price></item>" ;	
...
$description = "Order created for: ". $this->_basket['cart_order_id'];
	...
	$description .= "Product Name: " . $product['name'] . ", Product Description: " . $product['description'] . ", Product Quantity: " . $product['quantity'] . ", Product Price: " . $product['price'] ;	
